...
## Fatto
- Design system carta/inchiostro (src/styles.css)
- Contenuti IT/EN/ES + pagine brevi ZH/JA (src/lib/content.ts)
...
- [x] Migliorare tutti i testi, eliminando le frasi a effetto e mantenendo il lessico Deleuze–Caillois
...
- Più semplice e più bello: meno struttura, più immagine
- Il testo compare solo al contatto/scorrimento, non è sempre a schermo
